...
public class MyLocationNewOverlay extends Overlay implements IMyLocationConsumer,
	...
	public MyLocationNewOverlay(IMyLocationProvider myLocationProvider, MapView mapView) {
		...
		setDirectionIcon(getBitmapFromVectorDrawable(mapView.getContext(),R.drawable.ic_current_location));
		//setDirectionIcon(((BitmapDrawable)mapView.getContext().getResources().getDrawable(R.drawable.ic_current_location)).getBitmap());
