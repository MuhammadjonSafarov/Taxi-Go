...
import uz.xia.taxigo.databinding.FragmentHomeBinding
import uz.xia.taxigo.ui.ILocationResultListener
import uz.xia.taxigo.ui.home.roads.ParkDialogFragment
...
import uz.xia.taxigo.utils.locationEnabled
...
class HomeFragment : Fragment(), MapListener, Marker.OnMarkerClickListener,
    ...
    private val poiMarkers by lazyFast { RadiusMarkerClusterer(requireContext()) }
    ...
    private fun setUpViews() {
        ...
        val bitmap = requireContext().getBitmapFromVector(R.drawable.cluster_marker)
        //val clusterIcon = BonusPackHelper.getBitmapFromVectorDrawable(requireContext(), R.drawable.marker_poi_cluster)
        poiMarkers.setIcon(bitmap)
        poiMarkers.textPaint.textSize = 12 * resources.displayMetrics.density
        poiMarkers.mAnchorV = ANCHOR_BOTTOM
    ...
    private fun setMarker(point: GeoPoint) {
        ...
        marker.setInfoWindow(MarkerInfoWindow(R.layout.fragment_home, map))
