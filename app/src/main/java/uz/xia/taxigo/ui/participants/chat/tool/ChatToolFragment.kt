package uz.xia.taxigo.ui.participants.chat.tool
...
import uz.xia.taxigo.databinding.LayoutAnnouncementAddPhotoBinding
import uz.xia.taxigo.ui.participants.chat.tool.adapter.FilesPagerAdapter
import uz.xia.taxigo.ui.participants.chat.tool.photo.adapter.PhotoSelectListener


private const val COLLAPSED_HEIGHT = 228

class ChatToolFragment : BottomSheetDialogFragment(), PhotoSelectListener {
        ...
        dialog?.let {
            ...
            val callback: OnPageChangeCallback = object : OnPageChangeCallback() {
                override fun onPageSelected(position: Int) {
                    ...
                    nextButton.isVisible = position != 3
                }
            }
