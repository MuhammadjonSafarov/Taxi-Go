...
import uz.xia.taxigo.databinding.FragmentStationAddBinding
import uz.xia.taxigo.utils.lazyFast
import uz.xia.taxigo.utils.widget.SimpleSpinner

@AndroidEntryPoint
class StationAddFragment : Fragment() {

    private var _binding: FragmentStationAddBinding? = null
    private val binding get() = _binding!!

    private val viewModel by viewModels<StationAddViewModel>()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentStationAddBinding.inflate(inflater, container, false)
